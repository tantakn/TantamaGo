...
class DualNet_256_24_semeai(nn.Module): # pylint: disable=R0902
    """Dual Networkの実装クラス。
    """
    def __init__(self, device: torch.device, board_size: int=BOARD_SIZE):
        ...
        # resnet前の畳み込み層
        self.conv_layer = nn.Conv2d(in_channels=7, out_channels=filters, kernel_size=3, padding=1, bias=False)
